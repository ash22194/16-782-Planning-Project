classdef SimDifferentialDriveRobot < handle
    %SimDifferentialDriveRobot Simulation of kinematic behavior of differential-drive robot
    ...
    %
    %   SimDifferentialDriveRobot properties:
    ...
    %
    %
    %   SimDifferentialDriveRobot methods:
