classdef ROSTimer < handle
    %ROSTimer Encapsulates a periodic timer object for the ROS examples
    %   This class ensures that the timer is properly deleted when its
    %   object goes out-of-scope or is cleared from the workspace.
    %
    %   t = ROSTimer(PERIOD, TIMERFCN) creates a timer object
    ...
    methods
        function obj = ROSTimer(period, timerFcn)
            %ROSTimer Create and start a timer
