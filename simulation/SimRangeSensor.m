classdef SimRangeSensor < robotics.algs.internal.GridAccess & handle
    %SimRangeSensor Simulation of range sensor readings
    ...
    methods
        ...
        function set.NumReadings(obj, numReadings)
            ...
            validateattributes(numReadings, {'double'}, ...
                {'nonempty', 'scalar', 'nonnan', 'real', 'finite'}, 'SimRangeSensor', 'NumReadings');
        ...
        function set.SensorNoise(obj, sensorNoise)
            ...
            validateattributes(sensorNoise, {'double'}, ...
                {'nonempty', 'scalar', 'nonnan', 'real', 'finite'}, 'SimRangeSensor', 'SensorNoise');
