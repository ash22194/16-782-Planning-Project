classdef RobotSimulator < handle
    ...
    %     rosshutdown
    %
    %   See also robotics.BinaryOccupancyGrid, SimRangeSensor, SimDifferentialDriveRobot.
...
%             exampleMaps = load(examplesFilePath);
            ...
            obj.Robot = SimDifferentialDriveRobot;
            ...
            obj.KinematicsTimer = ROSTimer(obj.Step, ...
                @obj.updateKinematics);
            obj.PlotTimer = ROSTimer(obj.PlotInterval, ...
                @obj.updatePlot);
    ...
    methods (Access = private)
        ...
        function setupLaserScanner(obj)
            ...
            obj.LaserSensor = SimRangeSensor();
            obj.LaserSensor.Map = obj.InternalMap;
